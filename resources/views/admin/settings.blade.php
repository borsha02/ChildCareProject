                    ...
                    <div class="tab-content active" id="fees-tab">
                        <div class="settings-grid">
                            <div class="setting-group">
                                ...
                                <input type="number" id="weekly_fee" name="weekly_fee" value="{{ $settings['fees']['weekly_fee'] ?? 0 }}" placeholder="Enter amount">
                                <span class="setting-description">Standard weekly fee per child</span>
                            </div>
                            <div class="setting-group">
                                <label for="monthly_fee">Monthly Fee</label>
                                <input type="number" id="monthly_fee" name="monthly_fee" value="{{ $settings['fees']['monthly_fee'] ?? 0 }}" placeholder="Enter amount">
                                <span class="setting-description">Standard monthly fee per child</span>
                            </div>
                            <div class="setting-group">
                                <label for="sibling_discount">Sibling Discount (%)</label>
                                <input type="number" id="sibling_discount" name="sibling_discount" value="{{ $settings['fees']['sibling_discount'] ?? 0 }}" placeholder="Enter percentage">
