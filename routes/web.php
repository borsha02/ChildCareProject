...
Route::middleware('auth')->prefix('admin')->group(function (){
    ...
    Route::get('/attendance/absent-pdf', [AdminController::class, 'exportAbsentChildrenPDF'])->name('admin.attendance.absent-pdf');
...
Route::middleware('auth')->prefix('parent')->group(function (){
    ...
    Route::post('/child-profile/{id}/request-activation', [ParentController::class, 'requestActivation'])->name('parent.child-profile.request-activation');
